...
LimitsConfigurationLoader.prototype = {
    load: function (callback) {
        ...
        if (this.limitsConfigurationSource.isUrl()) {
            this.loadConfigFromURL(this.configEndpoint, forwardValidConfigCallback);
        } else if (this.limitsConfigurationSource.isFilePath()) {
            this.loadConfigFromFile(this.limitsConfigurationSource.parsedConfigEndpoint.path, forwardValidConfigCallback);
        } else {
    ...
    loadConfigFromURL: function (url, forwardValidConfigCallback) {
        request({
            url: url,
            json: true
    ...
    loadConfigFromFile: function (path, forwardValidConfigCallback) {
