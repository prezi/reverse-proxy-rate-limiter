...
function LimitsEvaluator(settings) {
    ...
    this.updateConfig(limitsConfig.defaultLimitsConfig);
    this.loadConfig();
...
LimitsEvaluator.prototype = {
    ...
    evaluate: function (req) {
        try {
            ...
            if (this.limitsConfiguration.maxRequests > 0 && this.counter.getGlobalRequestCount() >= this.limitsConfiguration.maxRequests) {
                // hard limit reached
            ...
            if (isGlobalRequestsUnlimited || this.counter.getGlobalRequestCount() < this.limitsConfiguration.maxRequestsWithoutBuffer) {
