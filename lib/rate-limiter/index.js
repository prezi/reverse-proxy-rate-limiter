...
function RateLimiter(settings) {
    ...
    this.settings = this.validateOptions(settings);
...
RateLimiter.prototype = {
    ...
    loadConfig: function () {
        try {
            var _this = this;
            limitsConfig.loadConfig(this.settings.configEndpoint, function (cfg) {
                if (cfg !== null) {
    ...
    forward: function (req, res) {
        ...
        this.proxy.web(req, res, {
            target: getForwardUrl(this.settings)
        });
    },
    ...
    getConfigEndpoint: function () {
        return this.settings.configEndpoint;
    },
