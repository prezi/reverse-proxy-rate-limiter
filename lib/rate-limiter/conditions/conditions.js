...
var subject, parameters, predicate, value;
...
function Condition(conditionArray) {
    ...
    if (this.subject.parameterCount === 0) {
        ...
        this.parameters = _.first(conditionArray, this.subject.parameterCount);
        conditionArray = _.rest(conditionArray, this.subject.parameterCount);
    }

    this.predicateName = conditionArray[0];
    this.predicate = findPredicate(this.predicateName);
    if (!_.contains(this.subject.predicates, this.predicate)) {
