...
RateLimiter.prototype = {
    ...
    initProxy: function () {
        ...
        this.proxyEvent.on('forward', this.onForward.bind(this));
    ...
    makeForward: function () {
        ...
        return function(req, res) {
            _this.proxyEvent.emit('forward', req);
    ...
    makeReject: function(reason, errorCode) {
        ...
        return function (req, res) {
            ...
            var handled = rl.proxyEvent.emit('rejectRequest', req, res, errorCode, reason)
            if (!handled) {
                this.rejectRequest(req, res, errorCode, reason);
            }
        }
    },
